...
OWI.controller('SettingsCtrl', ["$rootScope", "$scope", "$uibModal", "$uibModalInstance", "$state", "StorageService", "DBService", "DataService", "UrlService", "GoogleAPI", function($rootScope, $scope, $uibModal, $uibModalInstance, $state, StorageService, DBService, UrlService, DataService, GoogleAPI) {
  var vm = this;
  ...
  vm.generateURL = function () {
    ...
    // data needs to be nested in {params: ...}
    ...
    // save URL and json in database

    // display url on frontend

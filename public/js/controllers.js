...
OWI.controller('SettingsCtrl', ["$rootScope", "$scope", "$uibModal", "$uibModalInstance", "$state", "StorageService", "DBService", "DataService", "UrlService", "GoogleAPI", function($rootScope, $scope, $uibModal, $uibModalInstance, $state, StorageService, DBService, DataService, UrlService, GoogleAPI) {
  var vm = this;
